...
- Windows (PowerShell): `./scripts/main.ps1 -Command setup -Environment dev` (or `prod`)
- macOS/Linux (bash): `./scripts/main.sh setup -e dev` (or `prod`)
- Alternative: `./scripts/setup.ps1 -Environment dev` (or `prod`) and `./scripts/setup.sh -e dev` (or `prod`)

2) Start services
- Windows: `./scripts/dev.ps1` (or `./scripts/main.ps1 -Command dev`)
- macOS/Linux: `./scripts/dev.sh` (or `./scripts/main.sh dev`)
...
#### Usage
- Windows (PowerShell): `./scripts/main.ps1 -Command setup -Environment dev` (or `prod`) or `./scripts/setup.ps1 -Environment dev` (or `prod`)
- macOS/Linux (bash): `./scripts/main.sh setup -e dev` (or `prod`) or `./scripts/setup.sh -e dev` (or `prod`)
